...
void VkRenderer::createGraphicsPipeline() {
    ...
    auto vertShaderPath =
            QLatin1String(":/res/shader/compiledShader/vert.spv");
    auto fragShaderPath =
            QLatin1String(":/res/shader/compiledShader/frag.spv");
    ...
    // 视点和裁剪会在vkCmdSetViewport/Scissor中动态设置
    ...
    rs.cullMode =
        VK_CULL_MODE_NONE; // 设置需要背面
    rs.frontFace =
        VK_FRONT_FACE_CLOCKWISE;    //顺时针绘制
    rs.lineWidth =
        1.0f;
